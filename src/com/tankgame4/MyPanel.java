...
public class MyPanel extends JPanel implements KeyListener, Runnable {
    ...
    public MyPanel() {
        ...
        //初始化图片对象
        image1 = Toolkit.getDefaultToolkit().getImage(MyPanel.class.getResource("Images/bomb_3.gif"));
        image2 = Toolkit.getDefaultToolkit().getImage(MyPanel.class.getResource("Images/bomb_2.gif"));
        image3 = Toolkit.getDefaultToolkit().getImage(MyPanel.class.getResource("Images/bomb_1.gif"));
    }
...
//        }
    ...
    public void hitTank(Bullet s, Tank enemyTank) {
        //判断s 击中坦克
